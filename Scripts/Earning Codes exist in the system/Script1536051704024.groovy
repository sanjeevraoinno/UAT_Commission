...
WebUI.click(findTestObject('Page_Callidus Cloud Commissions Man/a_Earning Codes'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.setText(findTestObject('Page_Callidus Cloud Commissions Man/input_Enter Search Terms'), 'bonus', FailureHandling.CONTINUE_ON_FAILURE)
