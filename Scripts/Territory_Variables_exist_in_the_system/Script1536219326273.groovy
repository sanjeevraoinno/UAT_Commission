...
WebUI.scrollToElement(findTestObject('Page_Callidus Cloud Commissions Man/option_TerritoryVariables'), 3)

WebUI.click(findTestObject('Page_Callidus Cloud Commissions Man/option_TerritoryVariables'))
