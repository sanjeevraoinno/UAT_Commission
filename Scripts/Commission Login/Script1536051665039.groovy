...
WebUI.setText(findTestObject('Page_Sales Performance Home/input_username'), 'rkulkarn@calliduscloud.com')

WebUI.setEncryptedText(findTestObject('Page_Sales Performance Home/input_password'), 'WcIEjFhlsgB1+K0jmcpkSg==')
