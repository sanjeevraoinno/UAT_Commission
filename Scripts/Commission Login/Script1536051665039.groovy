...
WebUI.setText(findTestObject('Page_Sales Performance Home/input_username'), GlobalVariable.PortalLogin)

WebUI.setText(findTestObject('Page_Sales Performance Home/input_password'), GlobalVariable.PortalPassword)
