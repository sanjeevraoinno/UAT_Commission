...
WebUI.scrollToElement(findTestObject('Page_Callidus Cloud Commissions Man/option_LookupTableVariables'), 4)

WebUI.click(findTestObject('Page_Callidus Cloud Commissions Man/option_LookupTableVariables'))
